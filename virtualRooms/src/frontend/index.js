...
ws.onmessage = function(ev){
	...
	if (firstw == "rooms"){
		...
		outp = outp.concat("\n");
		// let sendMsg = msg[0].concat(msg[1]);
		console.log("sendMsg");
		console.log(outp);
...
function paintRooms(room, users){
	...
	// document.body.insertBefore(roomDiv, document.querySelector('#create'));
	roomDiv.appendChild(usersp);//, document.querySelector('#create'));
	roomDiv.appendChild(roomNameDiv);//, document.querySelector('#create'));
	roomDiv.appendChild(roomNameSpan);//, document.querySelector('#create'));
	roomDiv.insertBefore(roomNameDiv, usersp);//, document.querySelector('#create'));
	roomDiv.insertBefore(roomNameSpan, roomNameDiv);//, document.querySelector('#create'));
	document.body.appendChild(roomDiv);//, document.querySelector('#create'));
...
function renderChatBox(data){
	...
	// document.body.replaceChild(chatDiv, rooms);
	sendText();
}
